...
class Plane(pygame.sprite.Sprite):
    def __init__(self, game):
        ...
        self.rect.y = 30 + random.randint(0, 200) # définition aléatoire de la position en y du jet
    ...
    def respawn(self):
        self.rect.x = 1200 + random.randint(0, 1000) # redéfinition aléatoire de la position en x du jet respawn
        self.rect.y = 20 + random.randint(0, 200) # redéfinition aléatoire de la position en y du jet respawn
